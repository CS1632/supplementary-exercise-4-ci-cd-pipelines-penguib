...
public class RentACatTest {
	...
	public void testCatAvailableFalseNumCats0() {
		assertFalse("Cat with id 2 was available", r.catAvailable(2));
	}
	...
	public void testCatAvailableTrueNumCats3() {
		...
		assertTrue("Cat with id 2 was not available", r.catAvailable(2));
	}
	...
	public void testCatExistsFalseNumCats0() {
		assertFalse("Cat existed with no cats added", r.catExists(2));
	}
	...
	public void testReturnCatFailureNumCats0() {
		assertFalse("Cat was successfully returned without being taken out", r.returnCat(2));
	}
	...
	public void testReturnCatNumCats3() {
		...
		assertTrue("Cat with id 2 wasn't able to be returned", r.returnCat(2));
